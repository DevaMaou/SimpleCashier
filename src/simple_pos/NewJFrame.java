  ...
  public void addtable(int id ,String Name, int Qty ,Double Price){
   ...
   double tot = 0.0 ;
    ...
    private void initComponents() {
        ...
        Hotcoffe = new javax.swing.JButton();
        ...
        kontol = new javax.swing.JButton();
        jButton12 = new javax.swing.JButton();
        jButton13 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        Hotcoffe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Untitled (6).png"))); // NOI18N
        Hotcoffe.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HotcoffeActionPerformed(evt);
            }
        });
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Untitled (8).png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Untitled (9).png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Untitled (11).png"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Untitled (10).png"))); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Untitled (14).png"))); // NOI18N
        ...
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Untitled (13).png"))); // NOI18N
        ...
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Untitled (12).png"))); // NOI18N
        ...
        kontol.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        kontol.setText("Pay");
        kontol.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kontolActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(kontol, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
                            .addComponent(bal)))
                    .addComponent(kontol, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(Hotcoffe, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(Hotcoffe, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void HotcoffeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HotcoffeActionPerformed
        // btn code
        int i = Integer.valueOf(q1.getText());
        ++i;
        q1.setText(String.valueOf(i));
        
        addtables(1, "Hot MilkCoffe  ", i, 2.99);
        
        cal();
        
    }//GEN-LAST:event_HotcoffeActionPerformed
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        addtables(2, "Ice MilkCoffe  ", i, 2.59);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        addtables(3, "Ice Choco Coffe  ", i, 7.99);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        addtables(4, "Breed Omlete  ", i, 9.29);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        addtables(7, "Ide  Manggo Milkshake", i, 12.99);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        addtables(8, "Ice Orage Milkshake  ", i, 13.99);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
       // btn code
        ...
        addtables(9, "Ice Strawbeey Milkshake  ", i, 4.99);
    ...
    private void kontolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kontolActionPerformed
        // pat btn
    ...
    }//GEN-LAST:event_kontolActionPerformed

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        int baris =jTable1.getSelectedRow();
        int kolom = jTable1.getSelectedColumn();
        String dataTable = jTable1.getValueAt(baris, kolom).toString();
        String Id_masakan = jTable1.getValueAt(baris, 0).toString();
        String nama_masakan = jTable1.getValueAt(baris, 1).toString();
        String jumlah_beli = jTable1.getValueAt(baris, 2).toString();
        String harga= jTable1.getValueAt(baris, 3).toString();
        Double total_bayar = tot;
        Double pembayaran = paid;
        Double uang = balance;
        String SQL = "Insert Into transaksi(id_masakan,nama_masakan,harga,total_bayar,jumlah_beli)"+"Values('"+Id_masakan+"','"+nama_masakan+"','"+harga+"','"+total_bayar+"','"+jumlah_beli+"')";
        ...
        try {
           b.setText("                         DimCave \n");
            b.setText(b.getText() + "                         Dalan Merr, \n");
            b.setText(b.getText() + "                         Surabaya,jawa, \n");
            b.setText(b.getText() + "                        099999999999999, \n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "Harga Total : " + total.getText() +"\n");
            b.setText(b.getText() + "Uang      : " + pay.getText() +"\n");
            b.setText(b.getText() + "Kembalian   : " + bal.getText() +"\n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Terimakasih tekah membeli...!"+"\n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
    ...
    private javax.swing.JButton Hotcoffe;
    ...
    private javax.swing.JButton kontol;
